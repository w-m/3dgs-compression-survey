...
for filename in os.listdir(folder_path):
    if filename.lower().endswith(('.png', '.jpg', '.jpeg')):
        if "_" in filename or "-" in filename: continue
        ...
        img_1x.save(os.path.join(folder_path, f"{base}_h{display_height}px.webp"), format="webp", quality=80)
        print(f'Resized and saved {base}_{display_height}px.webp to {new_width_1x}x{display_height}')
